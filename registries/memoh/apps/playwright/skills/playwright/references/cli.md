...
```bash
export MEMOH_SKILLS_DIR="${MEMOH_SKILLS_DIR:-/data/skills}"
export PWCLI="${MEMOH_SKILLS_DIR:-/data/skills}/playwright/scripts/playwright_cli.sh"
"$PWCLI" --help
```

Memoh installs these Skills in the selected workspace under `${MEMOH_SKILLS_DIR:-/data/skills}`.
