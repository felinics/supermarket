...
- If push fails because of authentication or a non-fast-forward update, inspect the error and branch state. Do not force-push or pull an unrelated branch automatically.
