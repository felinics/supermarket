...
export const MAX_REGISTRY_APP_SKILLS = 128
export const MAX_REGISTRY_APP_RELEASE_BYTES = 8 * 1024 * 1024
export const MAX_REGISTRY_APP_ARTIFACT_COMPRESSED_BYTES = 128 * 1024 * 1024
export const MAX_REGISTRY_APP_ARTIFACT_UNCOMPRESSED_BYTES = 128 * 1024 * 1024
export const MAX_REGISTRY_APP_ARTIFACT_ARCHIVE_BYTES = 128 * 1024 * 1024
export const MAX_REGISTRY_APP_ARTIFACT_FILES = 10_000
